...
-- 创建库
create database if not exists zhangxuhui;
...
(
    ...
    tags       varchar(1024)                      null comment '标签列表（json 数组,难易程度区分）',
    answer     text                               null comment '题目答案',
    submitNum  int      default 0                 not null  comment '提交答案人数',
...
(
    id         bigint auto_increment comment 'id' primary key,
    language      varchar(125)                    null comment '编程语音',
